#!/usr/bin/env bash
# Build the Synria + checkers tabletop training scene on the Linux RTX 5090.
# Requires Isaac Sim 5.1 installed via pip in a Python 3.11 venv.
set -euo pipefail

REPO_ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/../.." && pwd)"
SCRIPT="$REPO_ROOT/isaac/scripts/build_synria_checkers_scene.py"
